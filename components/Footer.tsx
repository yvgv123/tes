export default function Footer() {
  return (
    <footer
      id="comm_link"
      className="w-full px-12 md:px-24 lg:px-48 py-12 bg-neutral-900 border-t border-cyan-400/10 flex flex-col justify-start items-center mt-0"
    >
      <div className="w-full max-w-[896px] flex flex-col justify-start items-start gap-10">
        ...
        <div className="self-stretch flex flex-col justify-start items-start gap-4">
          <div className="self-stretch flex flex-col justify-start items-center">
            <div className="text-center text-fuchsia-300 text-sm font-bold font-['Space_Grotesk'] uppercase leading-5 tracking-[5.60px]">
          ...
          <div className="self-stretch flex flex-col sm:flex-row justify-center items-center gap-4 sm:gap-6">
            ...
            <a
              ...
              className="px-8 md:px-10 py-4 outline outline-1 outline-offset-[-1px] outline-sky-100/40 hover:outline-sky-100/80 hover:bg-sky-100/5 flex justify-start items-center gap-3 transition-all group"
            >
              <div className="w-3 h-2.5 bg-sky-100 group-hover:shadow-[0_0_8px_rgba(224,242,254,0.8)] transition-all flex-shrink-0"></div>
              <div className="text-center text-sky-100 text-xs font-normal font-['Space_Grotesk'] leading-4 tracking-wider whitespace-nowrap">
            ...
            <a
              ...
              className="px-8 md:px-10 py-4 outline outline-1 outline-offset-[-1px] outline-fuchsia-300/40 hover:outline-fuchsia-300/80 hover:bg-fuchsia-300/5 flex justify-start items-center gap-3 transition-all group"
            >
              ...
              <div className="text-center text-fuchsia-300 text-xs font-normal font-['Space_Grotesk'] leading-4 tracking-wider whitespace-nowrap">
