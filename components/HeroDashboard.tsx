    ...
    >
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 items-stretch w-full h-full" style={{ minHeight: 'calc(100svh - 100px)' }}>
        ...
        >
          ...
          >
            <motion.div variants={itemVariants} className="flex items-center gap-2">
              ...
              <span className="text-[9px] md:text-[10px] text-brand-stone/60 tracking-[0.25em] font-space uppercase">Identity_Verified</span>
            </motion.div>

            <motion.h1 variants={itemVariants} className="text-[clamp(40px,10vw,108px)] font-black font-sans leading-[0.85] tracking-tighter uppercase relative w-fit">
            ...
            <div className="flex flex-col xl:flex-row xl:items-end justify-between gap-4 xl:gap-3 mt-1">
              <motion.div variants={itemVariants} className="flex flex-col gap-0.5">
                <span className="text-[9px] md:text-[10px] text-brand-stone/50 tracking-[0.2em] font-space uppercase">Operator Identification</span>
                <span className="text-base lg:text-xl font-bold font-sans text-brand-stone uppercase tracking-wide">Galih Rangga S.</span>
                <span className="text-[8px] md:text-[9px] text-brand-stone/30 tracking-[0.2em] font-space font-light uppercase">0X7F_PROTOCOL_INITIATED</span>
              </motion.div>
              <motion.div variants={itemVariants} className="flex flex-wrap gap-3">
                <button
                  onClick={scrollToProjects}
                  className="px-4 sm:px-5 py-2.5 bg-[#E09DF8] hover:bg-[#F0ABFC] text-black transition-all text-[9px] md:text-[10px] tracking-[0.2em] uppercase font-bold shadow-[0_0_15px_rgba(224,157,248,0.2)] rounded-[2px]"
                >
                  View_Archives
                </button>
                <button
                  onClick={scrollToContact}
                  className="px-4 sm:px-5 py-2.5 bg-transparent border border-brand-stone/20 hover:border-brand-stone/50 text-brand-stone hover:text-white transition-all text-[9px] md:text-[10px] tracking-[0.2em] uppercase font-bold backdrop-blur-sm rounded-[2px]"
                >
                  Establish_Link
                </button>
              </motion.div>
        ...
        <motion.div 
          ...
          className="w-full flex flex-col gap-3 lg:col-span-5 xl:col-span-4 lg:h-full"
        >

          {/* Top Right Card: Current Node */}
          <div
            className="w-full flex-1 p-4 bg-[#171717]/60 rounded-[10px] backdrop-blur-md flex flex-col justify-between gap-2 relative overflow-hidden group transition-all duration-500 hover:bg-[#171717]/80"
            style={{
              border: `1px solid ${outlineColor}33`,
          ...
          >
            <div className="w-full flex justify-between items-start gap-4">
              <div className="text-brand-stone text-[9px] md:text-[10px] font-space leading-[1.8] tracking-[0.15em] uppercase break-words">
              ...
              <div className="text-brand-cyan animate-pulse drop-shadow-[0_0_8px_#00F0FF] opacity-80 shrink-0 flex justify-center items-center">
                <svg width="25" height="18" viewBox="0 0 25 18" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-5 md:w-6 h-auto">
            ...
            <div className="w-full text-brand-stone/60 text-[11px] md:text-xs font-space leading-relaxed flex-1 mt-2 text-justify md:text-left">
          ...
          <div
            className="w-full flex-1 p-5 bg-[#171717]/60 rounded-[10px] backdrop-blur-[10px] flex flex-col justify-start items-start overflow-hidden group transition-all duration-500 hover:bg-[#171717]/80"
            style={{
              border: `1px solid ${outlineColor}33`,
              boxShadow: `0 0 20px rgba(235,178,255,0.05), inset 0 0 15px ${outlineColor}1A`,
            }}
            ...
            <div className="w-full flex-1 relative flex flex-col justify-start items-start gap-4 mt-2">
              {[
                ...
                <div key={label} className="w-full pb-3 border-b border-white/5 inline-flex justify-between items-end group/skill hover:border-[#f0abfc]/40 transition-colors cursor-default">
                  <div className="text-brand-stone/60 group-hover/skill:text-brand-stone transition-colors text-[10px] md:text-[11px] font-space uppercase break-words pr-2">{label}</div>
                  <div className="text-sky-100 group-hover/skill:text-[#f0abfc] group-hover/skill:drop-shadow-[0_0_5px_#f0abfc] transition-all text-[10px] md:text-[11px] font-space uppercase font-bold tracking-widest text-right shrink-0">[ {level} ]</div>
                </div>
              ))}
              <div className="w-full mt-4 flex flex-col justify-start items-start">
                <div className="w-full text-sky-100/20 text-[8px] font-space tracking-[0.4em] font-light leading-snug break-all uppercase overflow-hidden max-h-12 md:max-h-none opacity-50 md:opacity-100">
